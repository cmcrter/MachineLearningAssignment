...
public class HummingbirdAgent : Agent
{
    ...
    //The layer that the flowers are on
    [SerializeField]
    private LayerMask flowerLayer;
    ...
    public override void Initialize()
    {
        ...
        flowerArea = flowerArea ?? GetComponentInParent<FlowerArea>();
    ...
    private void MoveToSafeRandomPosition(bool inFrontOfFlower)
    {
        ...
        while (!safePositionFound && attemptsRemaining > 0)
        {
            ...
            Collider[] colliders = Physics.OverlapSphere(potentialPosition, 0.05f, ~flowerLayer);
